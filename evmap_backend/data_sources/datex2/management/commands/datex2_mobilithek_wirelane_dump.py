...
SOURCE = "mobilithek_wirelane"


class Command(BaseCommand):
    help = "Connects to Mobilithek API to extract static charger information for Germany provided by Wirelane"
...
def get_mobilithek_data():
    response = requests.get(
        API_URL,
        params={
            "subscriptionID": os.environ["MOBILITHEK_WIRELANE_STATIC_SUBSCRIPTION_ID"],
        },
